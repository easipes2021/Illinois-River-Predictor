...
LOG_FILE = 'prediction_log_beta.json'
SCORES_FILE = 'accuracy_scores_beta.json'
TRAINING_DATA = 'master_training_data_beta.csv'
MAX_LOG_AGE_DAYS = 30
...
def score_past_predictions():
    ...
    for entry in entries:
        ...
        try:
            ...
            # Parse directly to pandas Timestamp which handles ISO offsets safely
            target_time = pd.to_datetime(raw_target, utc=True)
...
def run_full_beta_accuracy_pipeline(forecast_results):
